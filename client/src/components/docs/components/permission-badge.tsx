...
const PERMISSION_CONFIG = {
  ...
  comment: { icon: MessageSquare, label: "Can comment", className: "bg-blue-50/95 dark:bg-blue-900/80 text-blue-700 dark:text-blue-300 border-blue-200 dark:border-blue-700" },
